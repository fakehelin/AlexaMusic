...
OWNER_ID = int(getenv("OWNER_ID", 6595772772))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Baretlijulietttt")

SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/Baretlijulietttt")
